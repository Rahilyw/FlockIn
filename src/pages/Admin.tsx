...
export default function Admin() {
  ...
  const createStatusMutation = (status: "approved" | "rejected") =>
    useMutation({
  ...
  const approveMutation = createStatusMutation("approved");
  const rejectMutation = createStatusMutation("rejected");
  const updatingId = approveMutation.variables ?? rejectMutation.variables;
